...
import { BrainCircuit, Mail, Lock, LogIn, Chrome } from "lucide-react";
    ...
    >
      ...
      <div className="flex flex-col items-center mt-4">
        ...
        <p className="text-xs text-slate-400 mt-1 text-center max-w-xs">
          Accede a tus listas colaborativas y activa el detector de precios más cercano.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-3 my-4">
        ...
        {!isRegistering && (
          <div className="text-right">
            <button
              ...
              onClick={() => alert("Simulando envío de correo de recuperación a: " + email)}
            >
        ...
        >
          ...
          <span>{isRegistering ? "Registrarse con Correo" : "Ingresar con Correo"}</span>
        </button>
      </form>
      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] text-slate-500 font-mono">O CONTINUAR CON</span>
          <div className="flex-1 h-px bg-slate-800" />
        </div>

          ...
          <div className='h-full flex flex-col justify-between'>
              ...
              <div className='flex flex-col gap-2 font-mono text-xs'>
                {logs.length === 0 ? (
                  <p className='text-slate-500 italic py-8 text-center'>
                    No hay eventos registrados de momento. Interactúa con el
                    simulador del móvil para gatillar geocercas, invitar
                    colaboradores o modificar listas.
                  </p>
                ) : (
                  logs.map((log) => (
                    <div
            ...
            <div className='mt-6 p-4 bg-slate-950 border border-slate-850 rounded-2xl'>
              ...
              <ol className='text-xs text-slate-400 list-decimal pl-4 flex flex-col gap-1.5 leading-normal'>
                <li>
                  Ve a la pestaña <b>"Mapa GPS"</b> en el menú inferior del
                  móvil.
                </li>
                <li>
                  Selecciona o configura tu radio (ej: <b>2 millas</b>).
                </li>
                <li>
                  Presiona el botón verde de <b>"SIMULAR"</b> en cualquiera de
                  las tiendas enlistadas.
                </li>
                <li>
                  Esto simulará que el teléfono cruza la geocerca. Recibirás un{' '}
                  <b>banner push del sistema</b> y una <b>alerta in-app</b>{' '}
                  vinculante para marcar el producto comprado.
                </li>
              </ol>
            </div>
          </div>
          ...
          <div className='flex flex-col h-full'>
            ...
            <div className='relative flex-1 bg-slate-950 border border-slate-850 rounded-2xl overflow-hidden flex flex-col justify-start'>
              <div className='bg-slate-950 px-4 py-2 flex justify-between items-center text-[10px] font-mono text-slate-500 border-b border-slate-900/80'>
                ...
                <button
                  onClick={() =>
                    handleCopyCode(getActiveCodeText(), activeCodeFile)
                  }
          ...
          <div className='flex flex-col gap-4'>
            <div>
              ...
              <p className='text-xs text-slate-400 leading-normal'>
                FOREMIND utiliza sensores de geofencing en segundo plano, lo
                cual exige justificaciones estrictas para pasar las directrices
                de Apple App Store y Google Play Store.
              </p>
            </div>
            ...
            <div className='p-4 bg-slate-950 border border-slate-855 rounded-2xl'>
              ...
              <ul className='text-xs text-slate-400 flex flex-col gap-2 list-none'>
                <li className='flex gap-2'>
                  ...
                  <div>
                    ...
                    <span className='text-[11px] block mt-0.5'>
                      Debes pedir explícitamente la aprobación al usuario en
                      primer plano, y luego enviarlo a los ajustes del sistema.
                    </span>
                  </div>
                </li>
                <li className='flex gap-2 mt-1'>
                  ...
                  <div>
                    <span className='font-bold text-slate-300 block'>
                      Formulario de Declaración de Ubicación:
                    </span>
                    <span className='text-[11px] block mt-0.5 italic text-slate-450 bg-slate-900 p-2 rounded border border-slate-800'>
                      "FOREMIND detecta supermercados a menos de 2 millas del
                      usuario para verificar productos pendientes de su lista
                      colaborativa. Este monitoreo requiere 'Ubicación en
                      Segundo Plano' para alertar al usuario mediante FCM sin
                      forzarlo a tener el celular encendido mientras conduce."
                    </span>
                  </div>
                </li>
              </ul>
            ...
            <div className='p-4 bg-slate-950 border border-slate-855 rounded-2xl'>
              ...
              <p className='text-[11px] text-slate-500 font-mono mb-2'>
                Debes agregar las siguientes llaves de descripción en tu archivo
                `Info.plist`:
              </p>
        ...
        {activeTab === 'privacy' && (
          <div className='flex flex-col gap-3'>
            <div className='flex justify-between items-center border-b border-slate-950 pb-2'>
              ...
              <button
                onClick={() =>
                  handleCopyCode(codeTemplates.privacyPolicy, 'privacy')
                }
            ...
            <div className='p-4 bg-slate-955 rounded-2xl border border-slate-850 text-slate-400 flex flex-col gap-2.5 text-xs'>
              <h4 className='font-bold text-slate-200'>
                Política de Privacidad Obligatoria para Google & Apple
              </h4>
              <p className='text-[11px] leading-relaxed text-slate-350'>
                Debido al rastreo en segundo plano, los revisores de Apple y
                Google comprueban que el sitio web de soporte cuente con una
